...
namespace App\Tests\Product\Application\UseCases\Query\FindProductById;
...
class FindProductByIdQueryHandlerFunctionalTest extends WebTestCase
{
    ...
    public function test_find_product_by_id_returns_product_dto(): void
    {
        ...
        $queryHandler = new FindProductByIdQueryHandler(
            $this->productQueryRepository,
            $this->productCategoryQueryRepository,
            $this->productImageQueryRepository
        );

        $query = new FindProductByIdQuery($product->getId()->getValue());
    ...
    public function test_product_return_null_when_not_find_by_id(): void
    {
        ...
        $query = new FindProductByIdQuery(999);
